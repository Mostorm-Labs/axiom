...
| G1/Task 2 | `GT-G1-02` | R1,R2 | REQ-OBJ, REQ-INK, REQ-TEXT | D-G1; codec/descriptor contract | GT-G1-01 | Pass | Implementing | Pass | `verification/evidence/gates/G1/<commit>/GT-G1-02/` | Protobuf C++ runtime/Abseil linkage not yet verified on host; hosted toolchain required for final codec acceptance | Blocked |
