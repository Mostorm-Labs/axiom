...
| WIRE-V1-04 | `EditRichTextOp.delta` inserted text aggregate | 8,388,608 bytes aggregate | no (requires typed branch semantics) | n/a | rich-text validator | A3 | COVERED |
...
Raw preflight is fail-closed on malformed/truncated wire, and does not replace
the canonical typed geometry counter.
