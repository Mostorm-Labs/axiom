...
| Semantic foundation | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-02R`、`GT-G1-03..08` | Validating | `GT-G1-01R`：[reconciliation Evidence](../../verification/evidence/gates/G1/42562d90a9403d8c3286cd0fa9972bac79a60bae/GT-G1-01R/)；`GT-G1-02`：`verification/evidence/gates/G1/1058311e47a2af68e4a444a76444dd6cf2354975/GT-G1-02/` + hosted revalidation；`GT-G1-02R`：durable [machine refreeze Evidence](../../verification/evidence/gates/G1/ac92939e70f0bbbf85f7ae126595f0e5522d4f7d/GT-G1-02R/)；[hosted run #33041434455](https://github.com/Mostorm-Labs/axiom/actions/runs/33041434455)；current main integration `26dcee011f4f35cfca7cd3f1d9a6c115e46853e2`，本分支 merge `aa90bd65427b98fec584dcc23079985a739123d6`；`GT-G1-03`：`verification/evidence/gates/G1/3c6cbbc6abe1dfb7b716e4c32e6546e476917c54/GT-G1-03/`；[G1-04 authority/task reconciliation](GT_G1_04_AUTHORITY_RECONCILIATION.md)；[G1-04-A re-entry Contract Matrix](GT_G1_04_A_CONTRACT_MATRIX.md) | GT-G1-04-A 当前为 `BLOCKED_AUTHORITY`：Operation/version、ObjectKind version、leaf structural 与 reviewed operation-corpus authority closure 尚未物化；随后仍需 GT-G1-04-B/C、G1-05～08、Operation-only Semantic Kernel、reviewed apply corpus、oracle、replay 与 Gate Report 通过。 |
...
| R 阶段条目 | 来源 Gate/Task | 状态 | Evidence | 剩余条件 |
| --- | --- | --- | --- | --- |
| Semantic Object/Operation/Snapshot | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-02R`、`GT-G1-03..08` | Blocked | `GT-G1-02R` durable machine refreeze Evidence 与 current main integration 已完成；[G1-04-A re-entry](GT_G1_04_A_CONTRACT_MATRIX.md) 明确当前 authority closure 缺口 | G1-04-A/B/C 必须先完成 authority、实现和验证；随后 G1-05/06/07/08 及跨任务集成退出条件通过。 |
