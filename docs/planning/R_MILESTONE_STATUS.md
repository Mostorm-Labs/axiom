...
| R 阶段条目 | 来源 Gate/Task | 状态 | Evidence | 剩余条件 |
| --- | --- | --- | --- | --- |
| Semantic Object/Operation/Snapshot | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-03..08` | Validating | `GT-G1-01R` reconciliation、`GT-G1-02` codec/differential、`GT-G1-03` object-store Evidence 已通过；G1-04 已完成 authority/task reconciliation | G1 Pass；V1 schema、Operation、History 和 Snapshot 语义闭合。 |
