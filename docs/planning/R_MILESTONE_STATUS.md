...
| Semantic foundation | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-03..08` | Validating | 既有 GT-G1-01R/02/03/02R Evidence；G1-04-A authority publication Evidence（本分支） | G1-04-A 仅完成 authority 闭合；仍需 A0–A3 implementation、B/C lanes、Operation-only Semantic Kernel、oracle、replay 与 Gate Report 通过。 |
...
| R 阶段条目 | 来源 Gate/Task | 状态 | Evidence | 剩余条件 |
| --- | --- | --- | --- | --- |
| Semantic Object/Operation/Snapshot | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-03..08` | Validating | 既有 GT-G1-01R/02/03/02R Evidence；G1-04-A current authority publication Evidence（本分支） | G1 Pass；V1 schema、Operation、History 和 Snapshot 语义闭合，且 G1-04-B/C 及后续任务通过。 |
