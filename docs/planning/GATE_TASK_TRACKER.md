...
| WP-G0-14 / IH-14 | `GT-G0-14` | PR CI dependency graph | R1 | REQ-GAP-VER | D-G0 | GT-G0-07, GT-G0-10..GT-G0-13 | Modify | Pass | Pass | Validating | [PR CI DAG Evidence](../quality/evidence/g0/gt-g0-14-pr-ci-dag-20260825.md)；`verification/evidence/g0/gt-g0-14/` | hosted PR DAG、deliberate-failure artifacts 与 commit-bound Evidence 尚待完成 | Validating |
