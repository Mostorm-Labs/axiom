...
| G1 | Validating | `GT-G1-01`、`GT-G1-01R`、历史 `GT-G1-02`、`GT-G1-02R` 与 `GT-G1-03` 已通过；`GT-G1-02R` 已集成为当前 RichText/Stroke machine projection baseline；`GT-G1-04-A` 正在进行 authority re-entry 分类 | G1 Gate 仍未满足整体退出条件；本次 re-entry 审计完成前不得开始 G1-04 实现。 |
