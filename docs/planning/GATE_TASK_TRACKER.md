...
| WP-G0-16 | `GT-G0-16` | Gate Report schema and G0 aggregator | R1 | REQ-GAP-VER | D-G0 | GT-G0-07, GT-G0-10..GT-G0-15 | Modify | Pass | Validating | Validating | [GT-G0-16 Gate Report Evidence](../quality/evidence/g0/gt-g0-16-gate-report-20260825.md)；`verification/evidence/g0/gt-g0-16/` | Implementation commit-bound Evidence and physical E4 authority remain open | Validating |
