...
| G1 | Validating | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02` 已通过；`GT-G1-03` repair/revalidation 进行中；其余任务未开始 | GT-G1-03 必需 hosted Evidence 通过，之后继续执行剩余 G1 任务 |
...
| G1/Task 3 | `GT-G1-03` | Implement ReferenceObjectStore and IndexedObjectStore | R1,R2 | REQ-OBJ, REQ-EDIT | D-G1 | GT-G1-02, GT-G1-01R | Modify | Pass | Pass | Validating | `verification/evidence/gates/G1/<new-source-commit>/GT-G1-03/ (repair pending)`；historical `verification/evidence/gates/G1/87fa1e6133aca09ea6b85d4587767610c52d7ecc/GT-G1-03/` | Required G1 Semantic Codec and CI Boundary Contract hosted validation must bind the repair source commit. POC-03 is not required Gate Evidence. | Validating |
