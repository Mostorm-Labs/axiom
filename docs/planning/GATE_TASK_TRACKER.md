...
| G0 | Validating | `GT-G0-00..GT-G0-06` Pass; `GT-G0-07` Validating; later G0 tasks remain Not Started | Commit-bind and hosted-CI validate `GT-G0-07`; complete `GT-G0-08..GT-G0-16`, produce reproducible G0 Evidence, then perform `GT-G0-17` review |
...
| WP-G0-07 / IH-07 | `GT-G0-07` | Shared CLI and protocol CI gate | R1 | REQ-GAP-VER | D-G0 | GT-G0-06 | Modify | Pass | Pass | Pass | [Shared CLI 与 Protocol CI Evidence](../quality/evidence/g0/gt-g0-07-shared-cli-protocol-ci-20260824.md)；`verification/evidence/gates/G0/<commit>/GT-G0-07/` | implementation `2292c16`; commit-bound hashes recorded; hosted CI run/artifact pending | Validating |
