...
| G0 | Validating | `GT-G0-00..GT-G0-08` Pass; `GT-G0-09` Validating; later G0 tasks remain Not Started | Bind `GT-G0-09` Evidence to its implementation commit, complete `GT-G0-10..GT-G0-16`, then perform `GT-G0-17` review |
...
| WP-G0-09 / IH-09 | `GT-G0-09` | Materialize 28 platform scenarios | R1 | REQ-GAP-VER, REQ-GAP-PLAT | D-G0 | GT-G0-01 | Missing | Pass | Pass | Validating | [Platform Scenario Corpus Evidence](../quality/evidence/g0/gt-g0-09-platform-scenarios-20260824.md)；`verification/evidence/g0/gt-g0-09/` | 28/28 and four Evidence reports pass on worktree; commit-bound regeneration pending | Validating |
