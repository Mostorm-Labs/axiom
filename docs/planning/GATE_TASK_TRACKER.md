...
| WP-G0-07 / IH-07 | `GT-G0-07` | Shared CLI and protocol CI gate | R1 | REQ-GAP-VER | D-G0 | GT-G0-06 | Modify | Pass | Pass | Pass | [Shared CLI 与 Protocol CI Evidence](../quality/evidence/g0/gt-g0-07-shared-cli-protocol-ci-20260824.md)；`verification/evidence/gates/G0/<commit>/GT-G0-07/`（commit-bound planned） | 本轮未提交；需提交后重跑并绑定 commit/tree/archive、托管 CI run 和 artifact | Validating |
