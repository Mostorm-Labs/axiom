...
| G1 | Validating | `GT-G1-01`、`GT-G1-01R`、`GT-G1-02`、`GT-G1-03` 已通过；`GT-G1-04` 已完成 authority/task reconciliation，准备实施；其余任务未开始 | G1-04 最终 validation 仍需要审阅式 15-operation apply corpus；G1 Gate 仍未满足整体退出条件 |
...
| G1/Task 4 | `GT-G1-04` | Implement normalize, validation, idempotency and ApplyPlan | R1,R2 | REQ-OBJ, REQ-EDIT, REQ-INK, REQ-TEXT | D-G1；ADR-0025、ADR-0026；07-03 Operation → Semantic Document | GT-G1-02, GT-G1-03 | Modify | Ready | Not Started | Blocked | [2026-08-27 authority/task reconciliation](GT_G1_04_AUTHORITY_RECONCILIATION.md)；`verification/evidence/gates/G1/<commit>/GT-G1-04/ (planned)` | 当前 authority 已明确 Normalize/Idempotency 与正确阶段顺序；最终 15-operation negative golden（人工审阅 intent、stage/path/outcome）尚未物化，不能由 production codec bless。 | Ready |
