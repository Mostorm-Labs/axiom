...
| G0 | Validating | `GT-G0-00..GT-G0-03` Pass; all later G0 tasks remain Not Started | Make GT-G0-03 Evidence commit-bound, complete `GT-G0-04..GT-G0-16`, produce reproducible G0 Evidence, then perform `GT-G0-17` review |
...
| WP-G0-03 / IH-03 | `GT-G0-03` | Runner core A: handshake, session, action, completion | R1 | REQ-GAP-VER | D-G0 | GT-G0-02 | Modify | Pass | Pass | Pass | [Runner Core A Evidence](../quality/evidence/g0/gt-g0-03-runner-core-a-20260823.md) | 当前 Evidence 基于 `0ab6ac0` 加未提交工作树；提交后需重做 commit-bound hashes | Pass |
