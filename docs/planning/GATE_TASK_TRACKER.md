...
| G0 | Validating | `GT-G0-00..GT-G0-07` Pass; `GT-G0-08` local design/implementation Pass and validation remains open; later G0 tasks remain Not Started | Bind `GT-G0-08` to a commit and applicable hosted CI, complete `GT-G0-09..GT-G0-16`, produce reproducible G0 Evidence, then perform `GT-G0-17` review |
...
| WP-G0-08 / IH-08 | `GT-G0-08` | Verification native hooks and common host | R1 | REQ-GAP-VER, REQ-GAP-PLAT | D-G0 | GT-G0-00, GT-G0-07 | Modify | Pass | Pass | Validating | [Native Hooks / Common Host Evidence](../quality/evidence/g0/gt-g0-08-native-hooks-common-host-20260824.md)；`verification/evidence/g0/gt-g0-08/` | implementation is uncommitted; commit-bound rerun/hosted CI pending; product normalized loss ingress does not yet exist and remains an explicit downstream integration gap | Validating |
...
| WP-G0-10 / IH-10 | `GT-G0-10` | Web reference adapter | R1 | REQ-GAP-VER, REQ-GAP-PLAT | D-G0 | GT-G0-08, GT-G0-09 | Modify | Not Started | Not Started | Not Started | `verification/evidence/gates/G0/<commit>/GT-G0-10/ (planned)` | — | Not Started |
| WP-G0-11 / IH-11 | `GT-G0-11` | Windows native adapter | R1 | REQ-GAP-VER, REQ-GAP-PLAT | D-G0 | GT-G0-08, GT-G0-09 | Modify | Not Started | Not Started | Not Started | `verification/evidence/gates/G0/<commit>/GT-G0-11/ (planned)` | — | Not Started |
