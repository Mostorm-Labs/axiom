...
| G0 | Validating | `GT-G0-00..GT-G0-07` Pass; later G0 tasks remain Not Started | Complete `GT-G0-08..GT-G0-16`, produce reproducible G0 Evidence, then perform `GT-G0-17` review |
