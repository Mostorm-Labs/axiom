...
| G1/Task 2 | `GT-G1-02` | Implement codec boundary and strict decode result | R1,R2 | REQ-OBJ, REQ-INK, REQ-TEXT | D-G1 | GT-G1-01 | Modify | Pass | Pass | Validating | `verification/evidence/gates/G1/<commit>/GT-G1-02/` | 本机已完成固定 Protobuf/Abseil runtime/codegen 编译与 round-trip；仍需 hosted Linux toolchain Evidence，且权威 BG/BGX 二进制及 differential oracle 尚未提供；工具对此返回 `BLOCKED_AUTHORITY` | Blocked |
| G1/Task 3 | `GT-G1-03` | Implement ReferenceObjectStore and IndexedObjectStore | R1,R2 | REQ-OBJ, REQ-EDIT | D-G1 | GT-G1-01 | Modify | Pass | Pass | Pass | `verification/evidence/gates/G1/87fa1e6133aca09ea6b85d4587767610c52d7ecc/GT-G1-03/` | v2 re-entry：Authority publication/manifest coverage 是 `DEFERRED_GOVERNANCE_DEBT`，不阻塞本任务；[hosted semantic CI](https://github.com/Mostorm-Labs/axiom/actions/runs/32981345556) 通过。 | Pass |
