...
| G1/Task 2 | `GT-G1-02` | Implement codec boundary and strict decode result | R1,R2 | REQ-OBJ, REQ-INK, REQ-TEXT | D-G1 | GT-G1-01 | Modify | Pass | Implementing | Pass | `verification/evidence/gates/G1/<commit>/GT-G1-02/` | Protobuf C++ runtime/Abseil linkage not yet verified on host; hosted toolchain required for final codec acceptance | Blocked |
