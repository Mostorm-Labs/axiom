...
int main() {
  const auto windows = canvas::input::normalizePlatformPointer(
      100, 7, 1, canvas::input::PointerTool::kPen, true, false, {2.0F, 3.0F, 0.0F});
  const auto android = canvas::input::normalizePlatformPointer(
      200, 3, 4, canvas::input::PointerTool::kEraser, true, true, {5.0F, 4.0F, 0.0F});
  const auto web = canvas::input::normalizePlatformPointer(
      300, 9, 2, canvas::input::PointerTool::kFinger, false, false, {10.0F, 10.0F, 0.0F});
