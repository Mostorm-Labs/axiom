...
int main() {
    ...
    std::cout << "correctness=" << (result.correctness_pass ? "PASS" : "FAIL")
              ...
              << " hierarchy=" << (result.hierarchy.applied ? "PASS" : "FAIL")
              << " connector_delete=" << (result.connector_delete.applied ? "PASS" : "FAIL")
              << " cascade=" << (result.controlled_cascade.applied ? "PASS" : "FAIL")
