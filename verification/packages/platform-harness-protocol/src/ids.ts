...
export type CompletionTokenId = Brand<string, "CompletionTokenId">;
...
export const COMPLETION_TOKEN_ID_PATTERN = /^completion:[A-Za-z0-9._-]+$/;
...
export const asCompletionTokenId = (value: unknown): CompletionTokenId => branded(value, COMPLETION_TOKEN_ID_PATTERN, "completion tokenId");
