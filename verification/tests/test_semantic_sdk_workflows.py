...
class SemanticSdkWorkflowTest(unittest.TestCase):
    ...
    def test_release_promotion_is_main_only_complete_and_immutable(self):
        ...
        self.assertIn('attestations: write', promote)
        ...
        self.assertIn('actions/attest-build-provenance@v2', promote)
        self.assertIn('out/semantic-release/*.zip', promote)
        self.assertIn('out/semantic-release/semantic-sdk-index.json', promote)
